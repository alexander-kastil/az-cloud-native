            ...
            ILogger logger)
        {
            ...
            foreach (var document in input)
            {
                ...
                if (evt != null)
                {
                    ...
                    {
                        //Create the order
                        logger.LogInformation($"Creating Order {evt.OrderId} for Customer {evt.CustomerId}", evt);
                    ...
                    else
                    {
                        ...
                        logger.LogInformation($"Updating Order {evt.OrderId} for Customer {evt.CustomerId}", evt);
